...
public class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["DiskRecycleBin"] = "Recycle Bin",
        ["DiskDeleteForever"] = "Delete permanently",
        ["DiskDeleteForeverFileConfirm"] = "This file is already in the Recycle Bin: it will be deleted permanently and cannot be recovered." + Environment.NewLine + "{0}",
        ["DiskDeleteForeverFolderConfirm"] = "This folder is already in the Recycle Bin: it and everything in it will be deleted permanently and cannot be recovered." + Environment.NewLine + "{0}",
        ["DiskDeleteForeverManyConfirm"] = "These {0} items ({1}) are already in the Recycle Bin: they will be deleted permanently and cannot be recovered." + Environment.NewLine + "{2}",
        ["DiskDeleteSomeForever"] = "{0} of them are already in the Recycle Bin: those will be deleted permanently.",
        ["DiskDeletingForever"] = "Deleting {0} permanently\u2026",
        ["DiskDeletingForeverMany"] = "Deleting {0} items permanently\u2026",
        ["DiskDeletedForever"] = "Deleted permanently",
        ["DiskDeletedForeverMany"] = "{0} items deleted permanently",
    ...
    private static readonly Dictionary<string, string> Spanish = new()
    {
        ...
        ["DiskRecycleBin"] = "Papelera de reciclaje",
        ["DiskDeleteForever"] = "Borrar definitivamente",
        ["DiskDeleteForeverFileConfirm"] = "Este fichero ya est\u00e1 en la papelera: se borrar\u00e1 definitivamente y no se podr\u00e1 recuperar." + Environment.NewLine + "{0}",
        ["DiskDeleteForeverFolderConfirm"] = "Esta carpeta ya est\u00e1 en la papelera: se borrar\u00e1n definitivamente ella y todo lo que contiene, y no se podr\u00e1n recuperar." + Environment.NewLine + "{0}",
        ["DiskDeleteForeverManyConfirm"] = "Estos {0} elementos ({1}) ya est\u00e1n en la papelera: se borrar\u00e1n definitivamente y no se podr\u00e1n recuperar." + Environment.NewLine + "{2}",
        ["DiskDeleteSomeForever"] = "{0} de ellos ya est\u00e1n en la papelera: esos se borrar\u00e1n definitivamente.",
        ["DiskDeletingForever"] = "Borrando {0} definitivamente\u2026",
        ["DiskDeletingForeverMany"] = "Borrando {0} elementos definitivamente\u2026",
        ["DiskDeletedForever"] = "Borrado definitivamente",
        ["DiskDeletedForeverMany"] = "{0} elementos borrados definitivamente",
